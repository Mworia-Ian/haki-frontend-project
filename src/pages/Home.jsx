function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <nav className=" sticky top-0 bg-white border-gray-200 dark:bg-gray-900 mb-8">
      ...
      <div className="flex min-h-screen items-center justify-center">
        <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          ...
          {user.role === "lawyer" ? (
            ...
            <p> Thank you for choosing us to be your partner in your journey to find credible and reliable legal representation! <br/>
            <em className="font-bold">Here you can find and hire legal experts.</em></p>
          )}
        </div>
      </div>
