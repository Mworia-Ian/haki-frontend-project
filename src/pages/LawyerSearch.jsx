    ...
    <div className="flex justify-end">
      <form className="w-full max-w-lg relative mt-5">
        ...
        <button
          type="button"
          onClick={onSearch}
          className="absolute right-1 top-1 bottom-1 px-4 py-1.5 text-sm font-medium text-white bg-[#37B9F1] rounded-lg border border-blue-700 hover:bg-[#32a6d8] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        >
          Search
        </button>
      </form>
